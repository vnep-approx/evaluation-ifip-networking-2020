...
Usage: ./plot_all_from_vm.sh <<folder_name>> <<reduced_results_pickle>>
Example: ./plot_all_from_vm.sh fixed-routing/plots-cleanup-test fixed-routing/fixed-synthetic_result_reduced.pickle'
